...
public record SsoProperties(
        ...
        /** Roles given to an account provisioned on first OTDS sign-in. Plural because an
         *  account here holds a set of roles, not one; left at {@code USER} because granting
